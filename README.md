...
| ---------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Mishra et al. (2021)**<br>*[Visual Brain Decoding for Short Duration EEG Signals](https://doi.org/10.23919/EUSIPCO54536.2021.9616192)*[^1]| - Applied preprocessing to remove noisy short trials<br> - **Approach**: CNN using a 14-channel subset<br> - Achieved \~70% accuracy on highly filtered data<br>          |
